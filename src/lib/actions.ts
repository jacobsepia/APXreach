 ...
 * Theirs alone, inside their workspace: membership is resolved on the server,
 * and a colleague's mailbox is never polled on someone else's click.
 */
